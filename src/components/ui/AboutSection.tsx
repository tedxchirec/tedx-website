  ...
  const stats = [
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-[#F5D6C6] mx-auto" viewBox="0 0 24 24" fill="none">
          <path d="M3 9H21M17 13.0014L7 13M10.3333 17.0005L7 17M7 3V5M17 3V5M6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#F5D6C6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-[#F5D6C6] mx-auto" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-[#F5D6C6] mx-auto" viewBox="0 0 24 24" fill="none">
          <path d="M18 14L16 21H8L6 14M4 10H20M6 9C6 6.79086 7.34315 5 9 5M9 5C9 6.10457 9.89543 7 11 7H14C15.1046 7 16 6.10457 16 5C16 3.89543 15.1046 3 14 3H11C9.89543 3 9 3.89543 9 5Z" stroke="#F5D6C6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      title: "Views Reached",
      icon: (
        <svg className="w-8 h-8 text-[#F5D6C6] mx-auto" viewBox="0 0 1024 1024" fill="none">
          <path d="M70.4 772c-13.6 0-24-10.4-24-24V140.8c0-13.6 10.4-24 24-24h882.4c13.6 0 24 10.4 24 24v607.2c0 16-11.2 24-22.4 24H70.4z m24-44h836V166.4H94.4V728z" fill="#F5D6C6"/>
          <path d="M733.6 662.4c-13.6 0-24-10.4-24-24s10.4-24 24-24h93.6c13.6 0 24 10.4 24 24s-12.8 24-24 24H733.6zM512 884c-13.6 0-24-10.4-24-24V758.4c0-13.6 10.4-24 24-24s24 10.4 24 24v103.2c-0.8 12-11.2 22.4-24 22.4z" fill="#F5D6C6"/>
          <path d="M316 904.8c-13.6 0-24-10.4-24-24s10.4-24 24-24h392.8c13.6 0 24 10.4 24 24s-12.8 24-24 24H316z" fill="#F5D6C6"/>
        </svg>
      )
    }
  ];
    ...
    >
      ...
      <div className="w-full max-w-4xl mx-auto text-center relative z-10 py-10 md:py-0 flex flex-col justify-center">
        ...
        <p className="text-base md:text-xl text-gray-300 mb-8 md:mb-12 leading-relaxed max-w-3xl mx-auto">
          TEDxChirec is a crucible of innovation, where the world&apos;s most audacious thinkers
          and creators converge. We don&apos;t just share ideas; we ignite movements. This year,
          we venture beyond the known, exploring the frontiers of science, art, and human
          consciousness.
        </p>
            ...
            <div className="relative overflow-hidden rounded-2xl border-2 border-red-500 shadow-2xl group">
              ...
              <div className="w-full h-56 md:h-80 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                <div className="text-center p-6 md:p-8">
                  ...
                  <div className="text-base md:text-lg text-gray-300 mb-1 md:mb-2">Chirec</div>
                  <div className="text-xs md:text-sm text-gray-500">Event Image Placeholder</div>
        ...
        {/* Call to Action */}
        <button
          className="bg-red-500 hover:bg-red-600 text-white px-5 md:px-6 lg:px-7 py-2.5 md:py-3 lg:py-3.5 rounded-full text-base md:text-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/25 max-w-xs md:max-w-sm mx-auto md:text-base lg:text-lg"
          style={{ minWidth: 'unset', fontSize: '1rem', paddingLeft: '1.5rem', paddingRight: '1.5rem', paddingTop: '0.75rem', paddingBottom: '0.75rem' }}
        >
          Join Our Community
        </button>
      </div>
